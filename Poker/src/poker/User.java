...
public class User {
    ...
    private int id;
    private int deleted;
    private String masterpassword = "Music";
    
    public User(int id){
        this.id = id;
    }
    
    public User(String login, String password) throws NoSuchAlgorithmException, UnsupportedEncodingException, Exception{
        this.login = login;
        this.password = Crypto.encrypt(masterpassword, password);

    }
    
    public User(String name, String login, String password) throws NoSuchAlgorithmException, UnsupportedEncodingException, Exception{
        this.name = name;
        this.login = login;
        this.password = Crypto.encrypt(masterpassword, password);
    }
